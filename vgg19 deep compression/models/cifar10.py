...
import numpy as np
from models.compressible_model import DTYPE, Compressible
import models.cifar10_data as cifar10_data
from models.cifar10_data import img_size, num_channels, num_classes
#tensorflow.disable_v2_bahaviour()
